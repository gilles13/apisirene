#' Codes et libelle naf niveau 5
#'
#' A dataset contenant les codes et libelle de la naf niveau 5
...
#' Codes et libelle des catégories juridiques de niveau 3
#'
#' A dataset contenant les codes et libelle des CJ niveau 3
#'  Les variables sont les suivantes
#'
#' @format A data frame with x rows and y variables:
#' \describe{
